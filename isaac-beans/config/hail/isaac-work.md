...
**Notifications to isaac (use exactly this format for comm_send content, ID first, emoji, **crew**, short action + slug from title):**
...
- Before handoff to planner (on conflict): `{{bean-id}} ➡️ **scrapper** handed off to planner`
