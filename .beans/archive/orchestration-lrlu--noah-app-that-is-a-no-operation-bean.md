...
- Beans root used: `/Users/zane/agents/orchestration/plan/orchestration`.
- Worker clone created at `/Users/zane/agents/orchestration/work/orchestration` from `git@github.com:slagyr/orchestration.git`.
